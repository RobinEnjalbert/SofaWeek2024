...
class Simulation(Sofa.Core.Controller):
    ...
    def __init__(self, root: Sofa.Core.Node, *args, **kwargs):
        ...
        scene = Scene(self.root, gravity=[0., -9810., 0.], dt=0.01, iterative=False, plugins=required_plugins)
        scene.addMainHeader()
        ...
        scene.Modelling.addObject(Controller(name='TripodController', root=self.root, step_size=0.05,
